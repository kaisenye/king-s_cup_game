...
import json
import sys
sys.path.append("/Users/kaisenye/GitHub/king-s_cup_game/py_source_code/")
from dict_func import get_key



# open json files/load dicts -----------------------------------------------------
with open('py_source_code/cards.json') as cards_dict:
    cards = json.load(cards_dict)
with open('py_source_code/cards_count.json') as cards_count_dict:
