...
function gameOver() {
    ...
    if (numberCnt.size == 0) {
        ...
        document.getElementById("data-content").textContent = "点击 卡片或者‘再来一局' 重新开始新一轮";
        document.getElementById("btn-text").textContent = "再来一局";
        document.getElementById("suit1").textContent = "";
        document.getElementById("suit2").textContent = "";
        document.getElementById("number1").textContent = "";
        document.getElementById("number2").textContent = "";
        document.getElementById("btn-text").onclick = function () { newGame(); };
        document.getElementById("data-card").onclick = function () { newGame(); };
    }
}
